...
now it’s enough to mention this [list of data
sets](http://www.kdnuggets.com/datasets/index.html), and DataCamp’s
[interactive
...
to check out DataCamp’s [interactive
...
or consider taking DataCamp’s [data.table
course](https://www.datacamp.com/courses/data-table-data-manipulation-r-tutorial/).

Are you not sure where to start? Check out [DataCamp’s course
